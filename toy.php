<?php   										// Opening PHP tag
	 ...
	 */
	 ...
	 function get_toy(PDO $pdo, string $id) {
		...
		// SQL query to retrieve all toy and manufacturer information based on the toynum parameter
		$sql = "SELECT toy.name AS toy_name, manuf.name AS manuf_name, manuf.*, toy.*
			FROM toy
